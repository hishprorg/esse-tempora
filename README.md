...
![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/alexreardon/@hishprorg/esse-tempora/test.yml)
![types](https://img.shields.io/badge/types-typescript%20%7C%20flow-blueviolet)
![npm bundle size](https://img.shields.io/bundlephobia/minzip/@hishprorg/esse-tempora)
![NPM Downloads](https://img.shields.io/npm/dm/@hishprorg/esse-tempora)

`@hishprorg/esse-tempora` is a _tiny_, widely-supported, zero-dependency alternative to [`invariant`](https://www.npmjs.com/package/invariant).
